...
// Importado isDateAvailable para o calendário mostrar os bloqueios
import { getStoredAppointments, isDateAvailable } from "@/data/mockData" 
import { useAuth } from "@/contexts/AuthContext"

// Tipo para agendamento (simplificado)
...
export default function Agenda() {
  ...
  useEffect(() => { 
    if (authProfessional) {
      loadAppointments(authProfessional.id)
    }
  }, [authProfessional]) 
  ...
  // --- FUNÇÃO: Determina se o dia está disponível/bloqueado --- 
    ...
    <div className="min-h-screen bg-background pb-20 relative">
      ...
      <div className="container mx-auto max-w-screen-lg px-4 py-4">
        ...
        {tab === "hora" && <>
          ...
          {/* Visualização de Horário (restante do código...) */}
          <div className="relative flex mt-4">
            ...
            <div className="flex-1 relative">
              ...
              {filteredAppointments.map((a) => {
                ...
                return <div key={a.id} className="absolute left-2 right-2" style={{ top: `${top}px`, height: `${height}px` }}>
